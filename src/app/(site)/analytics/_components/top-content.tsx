...
import { getTopContents } from "../fetch";

export async function TopContent() {
  const data = await getTopContents();
    ...
    <div className="rounded-[10px] bg-white p-4 shadow-1 dark:bg-gray-dark dark:shadow-card sm:p-6 xl:p-7.5">
      ...
      <div className="flex flex-col gap-2">
        <div className="grid grid-cols-10 py-2">
          <div className="col-span-6 text-body-sm font-medium">URL</div>
          ...
          return (
            <div key={index} className="grid grid-cols-10 [&>div]:py-2">
              <div className="relative z-1 col-span-8 grid grid-cols-8">
                <div
                  className="absolute left-0 top-0 -z-1 h-full rounded bg-gray-2 dark:bg-[#FFFFFF1A]"
